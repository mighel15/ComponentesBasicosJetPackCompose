...
@Composable
private fun PreviewItemCardDetailed(){
//    val menuItems = listOf("Guardar", "Editar", "Eliminar")
//    HCItemCardDetailed(
//        thumbnailPainter = painterResource(id = R.drawable.img_user_tag),
//        title = "Vargas Colquehuanca Juan Carlos",
//        subtitle = "DNI: 12345678",
//        tipo = "Mensual",
//        gridHeaders = listOf("Header 1", "Header 2", "Header 3"),
//        gridData = listOf("Data 1", "Data 2", "Data 3"),
//        gridColumns = 1,
//        menuItems = menuItems,
